...
//// 각 월별 전체 지점에서 최대 매출 ////
// let maxValInMonth = []
// let maxValInMonthData = maxSalesInMonthData
...
// /* 페이징 처리 */
// let monthTableRow = monthChartTable();
// let monthTableDate = Object.values(monthTableRow.order_date)
// let monthTableName = Object.values(monthTableRow.name)
// let monthTableSales = Object.values(monthTableRow.payment)
//
//
// // for(let i=0; i<Object.keys(monthTableRow.order_date); i++){
// //     monthTableDate.push(monthTableRow.order_date[i])
// //     monthTableName.push(monthTableRow.name[i])
// //     monthTableSales.push(monthTableRow.payment[i])
// // }
//
//
// $("#pagination-container").pagination({
//     dataSource: monthTableSales,
